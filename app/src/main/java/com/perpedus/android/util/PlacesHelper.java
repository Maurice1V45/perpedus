...
public class PlacesHelper {
    ...
    private void initPlaceTypesMap() {
        ...
        placeTypeMap.put("establishment", new Object[]{R.string.place_type_establishment, bitmapEstablishment, R.drawable.icon_establishment, R.drawable.icon_establishment_white, false});
        placeTypeMap.put("finance", new Object[]{R.string.place_type_finance, bitmapFinance, R.drawable.icon_finance, R.drawable.icon_finance_white, false});
        ...
        placeTypeMap.put("food", new Object[]{R.string.place_type_food, bitmapFood, R.drawable.icon_food, R.drawable.icon_food_white, false});
        ...
        placeTypeMap.put("general_contractor", new Object[]{R.string.place_type_general_contractor, bitmapGeneralContractor, R.drawable.icon_general_contractor, R.drawable.icon_general_contractor_white, false});
        ...
        placeTypeMap.put("health", new Object[]{R.string.place_type_health, bitmapHealth, R.drawable.icon_health, R.drawable.icon_health_white, false});
        ...
        placeTypeMap.put("place_of_worship", new Object[]{R.string.place_type_place_of_worship, bitmapPlaceOfWorkship, R.drawable.icon_place_of_worship, R.drawable.icon_place_of_worship_white, false});
